...
export class Service {
  ...
  async get (id, params) {
    ...
    return { buffer: this.btoa(buffer), type: response.ContentType }
  }
  ...
  async remove (id, params) {
    ...
    // send command
    return this.s3Client.send(new DeleteObjectCommand(commandParams))
  }
  ...
  async createMultipartUpload (data, params) {
    ...
    // Send command
    return await this.s3Client.send(new CreateMultipartUploadCommand(commandParams))
  }
  ...
  async completeMultipartUpload (data, params) {
    ...
    // send command
    return this.s3Client.send(new CompleteMultipartUploadCommand(commandParams))
  }
  ...
  async uploadPart (data, params) {
    ...
    // send command
    return this.s3Client.send(new UploadPartCommand(commandParams))
  }
  ...
  async putObject (data, params) {
    ...
    // send command
    return this.s3Client.send(new PutObjectCommand(commandParams))
  }
}
