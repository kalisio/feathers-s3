...
export class Service {
  ...
  async uploadPart (data, params) {
    // check data object
    if (!data.id) throw new BadRequest('uploadPart: expected missing \'data.id\' parameter')
    if (!data.UploadId && !data.UploadId) throw new BadRequest('uploadPart: expected missing \'data.UploadId\' parameter')
    if (!data.PartNumber) throw new BadRequest('uploadPart: expected missing \'data.PartNumber\' parameter')
    if (!data.buffer) throw new BadRequest('uploadPart: expected missing \'data.buffer\' parameter')
    if (!data.type) throw new BadRequest('uploadPart: expected missing \'data.type\' parameter')
  ...
  async putObject (data, params) {
    // check data object
    if (!data.id) throw new BadRequest('putObject: expected missing \'data.id\' parameter')
    if (!data.buffer) throw new BadRequest('putObject: expected missing \'data.buffer\' parameter')
    if (!data.type) throw new BadRequest('putObject: expected missing \'data.type\' parameter')
